    ...
    (function(a) {
        var d = "ekkoLightbox",
            ...
            g = function() {
                function d(c, e) {
                    var g = this;
                    b(this, d), this._config = a.extend({}, f, e), this._$modalArrows = null, this._galleryIndex = 0, this._galleryName = null, this._padding = null, this._border = null, this._titleIsShown = !1, this._footerIsShown = !1, this._wantedWidth = 0, this._wantedHeight = 0, this._modalId = "ekkoLightbox-" + Math.floor(1e3 * Math.random() + 1), this._$element = c instanceof jQuery ? c : a(c);
                    var h = '<div class="modal-header"' + (this._config.title || this._config.alwaysShowClose ? "" : ' style="display:none"') + '><button type="button" class="close" data-dismiss="modal" aria-label="' + this._config.strings.close + '"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">' + (this._config.title || "&nbsp;") + "</h4></div>",
                        i = '<div class="modal-footer"' + (this._config.footer ? "" : ' style="display:none"') + ">" + (this._config.footer || "&nbsp;") + "</div>",
                        j = '<div class="modal-body"><div class="ekko-lightbox-container"><div class="ekko-lightbox-item fade in"></div><div class="ekko-lightbox-item fade"></div></div></div>',
                        k = '<div class="modal-dialog" role="document"><div class="modal-content">' + h + j + i + "</div></div>";
                ...
                return c(d, null, [{
                    ...
                    value: function() {
                        ...
                        return this._$lightboxBodyTwo.hasClass("in") && (b = this._$lightboxBodyOne, c = this._$lightboxBodyTwo), c.removeClass("in"), setTimeout(function() {
                    ...
                    key: "_toggleLoading",
                    value: function(b) {
                        return b = b || !1, b ? (this._$modalDialog.css("display", "none"), this._$modal.removeClass("in"), a(".modal-backdrop").append(this._config.loadingMessage)) : (this._$modalDialog.css("display", "block"), this._$modal.addClass("in"), a(".modal-backdrop").find(".ekko-lightbox-loader").remove()), this
                    }
                }, {
                    ...
                    value: function(b, c) {
                        ...
                        return c && ! function() {
                            ...
                            e.onload = function() {
                                ...
                                var b = a("<img />");
                                return b.attr("src", e.src), b.addClass("img-fluid"), c.html(b), d._$modalArrows && d._$modalArrows.css("display", ""), d._resize(e.width, e.height), d._toggleLoading(!1), d._config.onContentLoaded.call(d)
                            }, e.onerror = function() {
                    ...
                    value: function(b, c) {
                        ...
                        return this._$lightboxContainer.css("height", j), this._$modalDialog.css("width", "auto").css("maxWidth", b), this._$modal.modal("_handleUpdate"), this
                    }
                }], [{
